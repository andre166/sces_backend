...
import com.sgte.sce.security.dto.JwtAuthenticationDto;
import com.sgte.sce.security.dto.TokenDto;
import com.sgte.sce.security.entities.Usuario;
import com.sgte.sce.security.repositories.UsuarioRepository;
import com.sgte.sce.security.utils.JwtTokenUtil;
...
public class AuthenticationController {
	...
	public ResponseEntity<Response<TokenDto>> gerarTokenJwt(@RequestBody JwtAuthenticationDto authenticationDto,
		...
		log.info("Gerando token para o email após o if {}.", authenticationDto.getUserName());
		...
		Usuario u = usuarioRepository.findByUserName(authenticationDto.getUserName());
	...
	public ResponseEntity<Response<TokenDto>> gerarRefreshTokenJwt(@Valid HttpServletRequest request) {
